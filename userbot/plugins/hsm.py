...
async def inline_id_handler(event: events.InlineQuery.Event):
    ...
    if not event.query.user_id == bot.uid:
        resultm = builder.article(title="me not your bot",description="Mind Your Business",text="Hey U Must Use LEGEND BOT = https://github.com/legend22/LEGEND-BOT ",buttons=[[Button.switch_inline("Search Again", query="tor ", same_peer=True)],], )
        await event.answer([resultm])
        return
...
async def inline_id_handler(event: events.InlineQuery.Event):
    ...
    if not event.query.user_id == bot.uid:
        resultm = builder.article(title="me not your bot",description="tere baap ka naukar smjha h kya ?",text="Hey U Must Use https://github.com/legendx22/LEGEND-BOT ",buttons=[[Button.switch_inline("Search Again", query="yt ", same_peer=True)],], )
        await event.answer([resultm])
        return
