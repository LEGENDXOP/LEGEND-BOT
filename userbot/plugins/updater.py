...
async def upstream(ups):
    ...
    await ups.edit("`Checking for LEGEND BOT updates, please wait....`")
    ...
    try:
        ...
        txt = "`Oops.. Updater cannot continue go to @LEGENDX22"
...
#make by LEGENDX22 🔥
    ...
    if force_update:
        ...
        await ups.edit(
            ...
            '`LEGEND BOT latest stable userbot code, please wait i find update for your bot`')
#make by LEGENDX22 🔥
    else:
    ...
    if HEROKU_APIKEY is not None:
        ...
        await ups.edit('`your LEGEND BOT is Successfully Updated!\n'

                       ' wait i am restarting...... All functions`')
